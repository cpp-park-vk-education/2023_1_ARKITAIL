...
void EventWidget::makeEventWidget(Wt::WTable *table, Wt::WDate begin_of_week) {
...
std::unique_ptr<Wt::WContainerWidget> EventWidget::makeEventPartWidget(std::string style_class) {
