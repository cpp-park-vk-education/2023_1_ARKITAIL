...
void event_manager::removeEvent(const int id) {
  dbo::Transaction transaction(session_);
...
void event_manager::upgradeEvent(Ret_Event &ret) {
  dbo::Transaction transaction(session_);
...
Ret_Event event_manager::getEvent(const int id) {
  dbo::Transaction transaction(session_);
