...
class CalendarHeaderWidget : public Wt::WContainerWidget {
  public:
    CalendarHeaderWidget();
    ~CalendarHeaderWidget() = default;

    Wt::Signal<std::unique_ptr<Wt::WDate>>& selectedDateChanged() { return change_selected_date_; }
  ...
  private:
    Wt::Signal<std::unique_ptr<Wt::WDate>> change_selected_date_;
