...
void WeekW::update(Wt::WDate selected_date_) {
    ...
    std::vector<EventW> events = {
        ...
        // EventW(1, "Event1", Wt::WColor(50, 20, 220, 50), Wt::WDateTime(Wt::WDate(2023, 5, 15),
        // Wt::WTime(12, 45)),
        //        Wt::WDateTime(Wt::WDate(2023, 5, 19), Wt::WTime(14, 0))),
        // EventW(2, "Event2", Wt::WColor(250, 20, 220, 50), Wt::WDateTime(Wt::WDate(2023, 5, 20),
        // Wt::WTime(12, 45)),
        //        Wt::WDateTime(Wt::WDate(2023, 5, 30), Wt::WTime(14, 0))),
        // EventW(3, "Event3", Wt::WColor(25, 20, 220, 50), Wt::WDateTime(Wt::WDate(2023, 5, 15),
        // Wt::WTime(12, 45)),
        //        Wt::WDateTime(Wt::WDate(2023, 5, 15), Wt::WTime(14, 0))),
        // EventW(4, "Event4", Wt::WColor(25, 200, 220, 50), Wt::WDateTime(Wt::WDate(2023, 5, 15),
        // Wt::WTime(0, 0)),
